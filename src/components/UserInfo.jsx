...
function UserInfo({ userSelected }) {
	...
	const userInfo = {
		...
		sex: userSelected?.sex === 'M' ? 'Male' : 'Female',
	};
					...
					<div className='more__info'>
						...
						<div className='user__indo-container'>
							<div className='monitoring__data-container'>
								<p className='monitoring__p'>Name : </p>
								<p className='monitoring__data'>
									{userInfo.firstName} {userInfo.lastName}
								</p>
							</div>
							<div className='monitoring__data-container'>
								<p className='monitoring__p'>Gender :</p>
								<p className='monitoring__data'>{userInfo.sex}</p>
							</div>
							<div className='monitoring__data-container'>
